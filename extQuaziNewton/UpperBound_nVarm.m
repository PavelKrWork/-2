...
function ReturnValue = UpperBound_nVarm(functname,x,s,a0,da,ns,nwzfp)
...
for i = 1:ntrials;
  j = 0;  dela = j*das;   a00 = a0 + dela;  
   dx0 = a00*s; x0 = x + dx0;
   try
   f0 = feval(functname,x0,nwzfp.Test,nwzfp.LTE_sb_2_up2,nwzfp.LTE_sb_5_up2,nwzfp.grid,nwzfp.ant,nwzfp.prec,nwzfp.far,nwzfp.dl2,nwzfp.ul,nwzfp.av,nwzfp.ah,nwzfp.offset);
   catch
       disp('error');
   end
   j = j+1;     dela = j*das;   a01 = a0 + dela;
   dx1 = a01*s; x1 = x + dx1;   f1 = feval(functname,x1,nwzfp.Test,nwzfp.LTE_sb_2_up2,nwzfp.LTE_sb_5_up2,nwzfp.grid,nwzfp.ant,nwzfp.prec,nwzfp.far,nwzfp.dl2,nwzfp.ul,nwzfp.av,nwzfp.ah,nwzfp.offset);
   f1s = f1;
   if f1 < f0 
         for j = 2:ntrials
           a01 = a0 + j*das;          dx1 = a01*s;    
            x1 = x + dx1;       f1 = feval(functname,x1,nwzfp.Test,nwzfp.LTE_sb_2_up2,nwzfp.LTE_sb_5_up2,nwzfp.grid,nwzfp.ant,nwzfp.prec,nwzfp.far,nwzfp.dl2,nwzfp.ul,nwzfp.av,nwzfp.ah,nwzfp.offset);
            f1s = min(f1s,f1);
            if f1 > f1s 

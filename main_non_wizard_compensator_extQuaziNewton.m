function main_non_wizard_compensator_extQuaziNewton(file_name, step_number,in_file_name_ofdm_sig_1,in_file_name_ofdm_sig_2)
    
    load(in_file_name_ofdm_sig_1,'LTE_sb_2_acc');

    load(in_file_name_ofdm_sig_2,'LTE_sb_5_acc');
    
    load('resample_filter_2_1_10','b');
...
%    LTE_sb_5_up2 = resample(LTE_sb_5_acc, 2, 1, 10); % columns are resampled independently
    ...
    LTE_sb_2_up2 = resample(LTE_sb_2_acc, 2, 1, imp); 

    LTE_sb_5_up2 = resample(LTE_sb_5_acc, 2, 1, imp); 
    ...
    nwzfp.LTE_sb_2_up2 = LTE_sb_2_up2;
    
    nwzfp.LTE_sb_5_up2 = LTE_sb_5_up2;
...
%                  xmin(av,ah) = xmin_tmp(1) + 1i*xmin_tmp(2);
                  ...
                  out_BFGS = BFGSm('non_wizard_compensator_funm', [0.5 0.5], 20 , 0.0001, 0,1 ,20, nwzfp);
                  
                  xmin(av,ah) = out_BFGS(1) + 1i*out_BFGS(2);
                 
                  fval(av,ah) = out_BFGS(3);
